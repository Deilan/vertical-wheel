...
| Exclusion | Settling после excluded candidate ощущается естественно |  | `feltSlip: yes/no; feltJump: yes/no; feltNatural: 1-5; finalSettleDurationMs:; nearestEligibleDistanceCards:; chosenTargetDirection:; comment:` |  |
