...
| Exclusion | Settling после excluded candidate ощущается естественно |  | `feltSlip: yes/no; feltJump: yes/no; feltNatural: 1-5; chosenTargetDirection:; directionPreserved:; reverseDirectionCandidateIgnored:; terminalContinuationDistanceCards:; terminalContinuationDurationMs:; finalSettleDurationMs:; comment:` |  |
